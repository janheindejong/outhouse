...
namespace OutHouse.Server.Migrations
{
    ...
    [Migration("20240311193153_RedoEverything")]
    partial class RedoEverything
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OutHouse.Server.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("OutHouse.Server.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OutHouse.Server.Models.Member", b =>
                {
                    b.HasOne("OutHouse.Server.Models.Outhouse", null)
                        .WithMany("Members")
                        .HasForeignKey("OuthouseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OutHouse.Server.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
